...
// Note: default database tables (services, orders, transactions, etc.)
// are created server-side via the Admin SDK the first time it connects
// (see lib/firebaseAdmin.js) — not from the browser. Doing it here would
// fail under locked-down security rules, since the client has no write
